...
async def brah(_, msg):
    await msg.reply("<blockquote><b>😍ᴠɪᴅᴇᴏ ᴄʜᴀᴛ sᴛᴀʀᴛᴇᴅ🥳</b></blockquote>")


# vc off
@app.on_message(filters.video_chat_ended)
async def brah2(_, msg):
    await msg.reply("<blockquote><b>😕ᴠɪᴅᴇᴏ ᴄʜᴀᴛ ᴇɴᴅᴇᴅ💔</b></blockquote>")
...
async def brah3(app: app, message: Message):
    ...
    try:
        ...
        reply_text = f"<blockquote><b>{text} 🤭🤭</b></blockquote>"

        await message.reply(
            reply_text,
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton(text="😘𝐉ᴏɪɴ 𝐕ᴄ 🤪", url=add_link)],
                ]
            ),
        )
